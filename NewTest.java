...
public class NewTest {
		...
		WebDriver we;
		XSSFSheet sh;
		int count = 1, count1 = 0, c = 0,k,i,as,tt,f;
		FileInputStream fi;
		XSSFWorkbook wb;
		FileOutputStream fo;
		 Select s;  Alert alert;
		XSSFCell c3;Actions ac;
		Robot robot;
		String AdvAdjst="No",ExcelPath = "E:\\Expenses\\Expense_new\\EE_TS_NEFT.xlsx";
		String voucherNo = "1", NetAmt = "no", voucherNoC = "1", voucherNo1 = "1", batchNo = "1";
		String payMode,con1, con1sts, conAp1,conAp1sts, mod, conM, conMsts, conApM, conApMsts;
	...
	@Test (priority=1)
	public void beforeTest() throws InterruptedException, Exception {
